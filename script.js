...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateCounter(element) {
        ...
        // Extract number and symbol (e.g., "20+", "98%")
    ...
    function validateForgotEmail(email) {
        if (!email) {
            showValidationMessage(forgotEmailValidation, '', '');
            return false;
        }

        if (!emailRegex.test(email)) {
            showValidationMessage(forgotEmailValidation, 'Please enter a valid email address', 'error');
            return false;
        }
    ...
    function checkEmailExists(email) {
        ...
        setTimeout(() => {
            ...
            const existingEmails = ['admin@financehub.com', 'user@example.com', 'test@financehub.com'];
            
            if (existingEmails.includes(email.toLowerCase())) {
                showValidationMessage(forgotEmailValidation, '✓ Email found. We can send a reset link.', 'success');
            } else {
                showValidationMessage(forgotEmailValidation, 'Email not found in our system. Please check your email address.', 'error');
            }
        }, 500);
    }
    ...
    if (forgotPasswordForm) {
        forgotPasswordForm.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                // Show success message
                showValidationMessage(forgotEmailValidation, 'Password reset link sent to your email!', 'success');
    ...
    // Removed parallax effect for better stability
